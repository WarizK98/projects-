...
<body>
<form action="formacc_post.php" method=POST>
<div style="margin:10px">
    ...
    $find_hackman=mysqli_query($con,"SELECT * FROM acc");
    while($row=mysqli_fetch_assoc($find_hackman))
    {
        ...
        echo"<p>owner name:$own_name<br>
             type of accessories:$enter<br>
            company of accessories:$company<br>
             color:$color<br>
             mobile number:$mobno<br>
             address of the owner:$address<br>
             Description:$desc<br>
             cash prize:$cashprize</p>";
            }
