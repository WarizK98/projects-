...
<body>
    ...
    <div class="content">
        ...
        <table style="width:100%">
            ...
            <form action="add.php" method="get">
            <tr>
                <td><input size="5"type="text" name="id" value="302" readonly /></td>
                <td><input size="5"type="text" name="sem" value=" 3" readonly/></td>
                <td><input size="35" type="text" name="name" value="Engineering Mathematics-III " readonly/></td>
                <td><input size="35" type="text" name="tb" value="Higher Engineering Mathematics" readonly/></td>
                <td><input size="35" type="text" name="author" value="H. K. Dass, Er. RajnishVerma" readonly></td>
            ...
            <form action="add.php" method="get">
            <tr>
                <td><input size="5"type="text" name="id" value="303" readonly /></td>
                <td><input size="5"type="text" name="sem" value="3" readonly/></td>
                <td><input size="35" type="text" name="name" value="Data Structures With Applications" readonly/></td>
                <td><input size="35" type="text" name="tb" value="Fundamentals of Data Structures in C" readonly/></td>
                <td><input size="35" type="text" name="author" value="Horowitz, Sahni, Anderson-Freed" readonly></td>
                <td>
                    <input type="text" class="input-group-button"  value="1" size="2" /><input type="submit" value="Add to Cart" class="btnAddAction" /></div>
            ...
            <form action="add.php" method="get">
            <tr>
                <td><input size="5"type="text" name="id" value="304" readonly /></td>
                <td><input size="5"type="text" name="sem" value="3" readonly/></td>
                <td><input size="35" type="text" name="name" value="Data Structures With Applications" readonly/></td>
                <td><input size="35" type="text" name="tb" value="Approach of Data Structures" readonly/></td>
                <td><input size="35" type="text" name="author" value="A.M Padma Reddy" readonly></td>
